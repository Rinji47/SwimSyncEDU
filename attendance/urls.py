...
urlpatterns = [
    ...
    path('admin/todays-classes/', views.admin_todays_classes, name='admin_todays_classes'),
    ...
    path('admin/trainer-history/<int:trainer_id>/mark/', views.admin_mark_trainer_attendance_for_day, name='admin_mark_trainer_attendance_for_day'),
    ...
    path('admin/group-class/<int:class_session_id>/cancel-day/', views.cancel_group_class_for_day, name='cancel_group_class_for_day'),
    path('admin/group-class/<int:class_session_id>/undo-cancel-day/', views.undo_cancel_group_class_for_day, name='undo_cancel_group_class_for_day'),
    path('admin/group-class/<int:class_session_id>/student/<int:student_id>/mark/', views.admin_mark_class_attendance, name='admin_mark_class_attendance'),
    ...
    path('admin/private-class/<int:private_class_id>/cancel-day/', views.cancel_private_class_for_day, name='cancel_private_class_for_day'),
    path('admin/private-class/<int:private_class_id>/undo-cancel-day/', views.undo_cancel_private_class_for_day, name='undo_cancel_private_class_for_day'),
    path('admin/private-class/<int:private_class_id>/mark/', views.admin_mark_private_attendance, name='admin_mark_private_attendance'),
